...
var Minecraft = function(init){
  ...
  (desk = function(){
    ...
    $('#desk').svg({onLoad: function(svg){
      ...
      for(m=0;m<surface;m++){
        for(n=0;n<surface;n++){
          ...
          b = svg.add('#box');
          var settings = {id: 'deskSlotImage'+n+'-'+m,class: 'deskSlotImage',pos: [m,0,n]};//x,z,y
      ...
      $('#rotate_btn').bind('click', function(){
          ...
          if(rotate){
            svg.change(document.getElementById('rotate_btn'),{'href':'images/rotate_push.png'});
          }else{
            svg.change(document.getElementById('rotate_btn'),{'href':'images/rotate.png'});
          }
    ...
    this.setSlot = function(elem, img){
  ...
  var lib = function(db, $){
    ...
    this.create_item = function(building_id){
      ...
      $('#library_wrapper').append(tag);
      $('#library_wrapper img').on('click', function(e){
  ...
  (stage = function(){
    ...
    scene.bind(light);
    CubicVR.setGlobalAmbient([0.8,0.8,0.8]);
      ...
      if(floorLevel != e.currentTarget.value){
        ...
        $('.deskSlotImage').each(function(ind, elem){
          ...
          if(item == null){
            ...
            stage.setSlot(e, './images/tranparent_image.png');
          }else{
            stage.setSlot(e, items[item.itemid].image);
